...
export const features: Feature[] = [
  ...
  },
  {
    ...
    desc: 'Peça pra se teleportar até um amigo com /tpa; os pedidos podem ser aceitos com /tpaccept. Pra chamar alguém até você, use /tpahere.',
    plugin: 'EssentialsX',
  },
  {
    slug: 'waystones',
    name: 'Viajar maisrápido pelo mapa',
    category: 'casa',
  ...
  {
    slug: 'voicechat',
    name: 'Chat de Voz por Proximidade',
    category: 'social',
  ...
  },
  {
    ...
    category: 'mundo',
    desc: 'Derrube árvores inteiras com um só golpe, basta agachar enquanto quebra o tronco usando um machado!',
    plugin: 'TreeFeller',
  },
  {
    slug: 'veinminer',
    name: 'Minerar veios de minérios por completo',
    category: 'mundo',
    desc: 'Quebre todos os minérios semelhantes ao que você está minerando com um só golpe! Basta agachar enquanto quebra o bloco usando a ferramenta correta.',
    plugin: 'VeinMiner',
  },
  {
    slug: 'sleeper',
    name: 'Pular a noite sem precisar esperar outros jogadores',
    category: 'mundo',
  ...
  {
    slug: 'imageframe',
    name: 'Colocar imagens da internet em mapas',
    category: 'criacao',
    command: '/imageframe create <nome> <link>',
    desc: 'Coloque uma imagem da internet na sua parede! Basta utilizar o comando do plugin com o link da sua imagem (Plataforma recomendada para transformar as imagens em links: https://postimages.org) e colocar os mapas em item-frames!',
    note: 'Precisa de permissão pra criar.',
    plugin: 'ImageFrame',
  },
  {
    slug: 'customdiscs',
    name: 'Discos de música personalizados',
    category: 'criacao',
    desc: 'O servidor oferece discos de músicas customizadas! Só a staff pode criá-los, mas todo mundo pode ouvi-los normalmente em jukeboxes (eles vêm junto nas resource packs).',
    plugin: 'URLCustomDiscs',
  },
  {
    slug: 'dynamiclight',
    name: 'Iluminação Dinâmica',
    category: 'criacao',
